...
function write_header()
{
   ...
   d.writeln('   <tr style="vertical-align: top; text-align: center; font-family: Lato; color: darkslategray; font-size: 12pt; letter-spacing: 3px; text-decoration: none">');
   d.writeln('      <td style="padding-left: 10px; padding-right: 10px"><a href="#">HOME</a></td>');
